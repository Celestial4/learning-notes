...
> v
>
> 称...为，将....命名为 denominate somebody (as) something 
>
> 以...为单位 denominate something (in something)
...
> （数量上、比例上）占
>
> account for somebody/something （尤指在事故之后）了解，查明
...
> v
>
> 1. 结束（争论、争端等）；解决（分歧、纠纷)等 settle something
> 2. （最终）决定，确定，安排好
> 3. 定居
> 4. 殖民；作为移民在殖民地定居
> 5. 使处于舒适的位置
...
> v
>
> * correspond (with somebody)	通信
> * correspond with something   相一致；符合 
> *  correspond (to something)   类似于；相当于
...
> n
>
> 1. 协同作用，协同增效作用（多方共同协作所产生的效果优于各自单独行动的效果）
